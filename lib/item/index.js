    ...
    */
    relatedItems: function() {
      ...
      relationshipTypes.forEach(function (rType) {
        getAllRelationships.push(item.request(`content/items/${itemId}/relatedItems`, {relationshipType: rType, direction: 'forward'}))
        getAllRelationships.push(item.request(`content/items/${itemId}/relatedItems`, {relationshipType: rType, direction: 'reverse'}))
      })
      console.log(getAllRelationships)
