  ...
  var organizationMethods = {
    ...
    update: function(options, cb) {
      ...
      .then(function(confirmation) {
        return organization.get(this.id)
      })
    ...
    featured: function({num = 100, page = 0, sort = 'created', order = 'desc'} = {}, cb) {
      var featuredPromise = this.get(this.id)
        .then(function (organization) {
          var featuredGroupId = organization.homePageFeaturedContent.split(':')[1]
          return organization.group(featuredGroupId)
          .then(function (group) {
